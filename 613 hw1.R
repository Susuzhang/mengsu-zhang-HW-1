...
dist11<-as.data.frame(sqrt((69.172*(dis1$ssslong-dis1$point_x)*cos(dis1$point_y/57.3))^2+(69.172*(dis1$ssslat-dis1$point_y))^2))
...
dist22<-as.data.frame(sqrt((69.172*(dis2$ssslong-dis2$point_x)*cos(dis2$point_y/57.3))^2+(69.172*(dis2$ssslat-dis2$point_y))^2))
...
dist33<-as.data.frame(sqrt((69.172*(dis3$ssslong-dis3$point_x)*cos(dis3$point_y/57.3))^2+(69.172*(dis3$ssslat-dis3$point_y))^2))
...
dist44<-as.data.frame(sqrt((69.172*(dis4$ssslong-dis4$point_x)*cos(dis4$point_y/57.3))^2+(69.172*(dis4$ssslat-dis4$point_y))^2))
...
dist55<-as.data.frame(sqrt((69.172*(dis5$ssslong-dis5$point_x)*cos(dis5$point_y/57.3))^2+(69.172*(dis5$ssslat-dis5$point_y))^2))
...
dist66<-as.data.frame(sqrt((69.172*(dis6$ssslong-dis6$point_x)*cos(dis6$point_y/57.3))^2+(69.172*(dis6$ssslat-dis6$point_y))^2))
# The distance between high schools of choice6 and junior high schools

dist<-cbind(dist11[,1],dist22[,1],dist33[,1],dist44[,1],dist55[,1],dist66[,1])
...
write.csv(datsch,file="exercise2.datsch.csv")
write.csv(dist,file="exercise3.dist.csv")
write.csv(zz2,file="exercise5.1.csv")
write.csv(yy2,file="exercise5.2.csv")
